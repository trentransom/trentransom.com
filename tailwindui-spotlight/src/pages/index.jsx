...
export default function Home({ articles }) {
  return (
    <>
      <Head>
        <title>
          Trent Ransom - Classical Musician turned Software Engineer
        </title>
        <meta
          name="description"
          content="I’m Trent, a classical musician and software engineer based in New York City. I’m the founder and CEO of Planetaria, where we develop technologies that empower regular people to explore space on their own terms."
        />
      </Head>
      <Container className="mt-9">
        <div className="max-w-2xl">
          <h1 className="text-4xl font-bold tracking-tight text-zinc-800 dark:text-zinc-100 sm:text-5xl">
            Classical Musician turned Software Engineer
          </h1>
          ...
          <div className="mt-6 flex gap-6">
            <SocialLink
              href="https://www.instagram.com/trenthegent/"
              aria-label="Follow on Instagram"
              icon={InstagramIcon}
            />
            <SocialLink
              href="https://github.com/trentransom"
              aria-label="Follow on GitHub"
              icon={GitHubIcon}
            />
            <SocialLink
              href="https://www.linkedin.com/in/trentransom/"
